...
class RvAdapter(var dataList: ArrayList<RvModel>, val context: Context) :
    RecyclerView.Adapter<RvAdapter.MyViewHolder>() {
    inner class MyViewHolder(private var view: View) : RecyclerView.ViewHolder(view) {
        val profile: ImageView = view.findViewById(R.id.item_image)
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.profile.setImageResource(dataList[position].foodImage)
